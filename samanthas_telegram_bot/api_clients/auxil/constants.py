...
API_URL_AGE_RANGES = f"{API_URL_PREFIX}/age_ranges/"
API_URL_DAY_AND_TIME_SLOTS = f"{API_URL_PREFIX}/day_and_time_slots/"
API_URL_ENROLLMENT_TESTS = f"{API_URL_PREFIX}/enrollment_test/"
API_URL_LANGUAGES_AND_LEVELS = f"{API_URL_PREFIX}/languages_and_levels/"
...
SMALLTALK_HEADERS = {"Authorization": f"Bearer {os.environ.get('SMALLTALK_TOKEN')}"}
SMALLTALK_RESULTING_LEVEL_UNDEFINED = "undefined"
SMALLTALK_TEST_ID = os.environ.get("SMALLTALK_TEST_ID")
